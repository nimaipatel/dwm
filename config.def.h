...
static const unsigned int baralpha = 255 * 0.7;
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_e,                              spawn,                 SHCMD("change-mode") },
	{ MODKEY|ShiftMask,             XK_e,                              spawn,                 SHCMD("change-font") },
	...
	{ 0,                            XF86XK_MonBrightnessUp,            spawn,                 SHCMD("brightnessctl set +2% ; pkill -RTMIN+19 dwmblocks") },
	{ 0,                            XF86XK_MonBrightnessDown,          spawn,                 SHCMD("brightnessctl set 2%- ; pkill -RTMIN+19 dwmblocks") },
	{ MODKEY|ShiftMask,             XK_k,                              spawn,                 SHCMD("brightnessctl set +2% ; pkill -RTMIN+19 dwmblocks") },
	{ MODKEY|ShiftMask,             XK_j,                              spawn,                 SHCMD("brightnessctl set 2%- ; pkill -RTMIN+19 dwmblocks") },
